		...
		function e(e) {
			...
			function ae(e) {
				...
				this.decode = function (e) {
					return (
						e.buffer instanceof SharedArrayBuffer && (e = new Uint8Array(e)), t.decode.call(t, e)
					);
				};
			}
			var h,
			...
			if (l) (u = i.wasmMemory), (fe = i.buffer);
				...
				!(
					(u = new WebAssembly.Memory({ initial: f / 65536, maximum: f / 65536, shared: !0 }))
			...
			function xe(e, t) {
				...
				var n = Atomics.load(_, x >> 2),
					r = 0;
				if (n == e && Atomics.compareExchange(_, x >> 2, n, 0) == n && ((r = 1), --t <= 0))
					return 1;
						...
						return i(n, (e = new Date(e.V + 1900, e.Da, e.Ga))) < 0
							? o(
									Math.ceil(
										(31 -
											n.getDate() +
											(it(ot(e.getFullYear()) ? st : ut, e.getMonth() - 1) - 31) +
											e.getDate()) /
											7
									),
									2
			...
			var At,
				...
				xt = {
					c: function (e, t, n, r) {
						y(
							'Assertion failed: ' +
								O(e) +
								', at: ' +
								[t ? O(t) : 'unknown filename', n, r ? O(r) : 'unknown function']
						);
					},
					E: function (e, t) {
						St(e, t);
					...
					K: function (e, t) {
						...
						if (!l && kt() == n)
							return d('Main thread ' + n + ' is attempting to join to itself!'), 16;
						if (_[(n + 12) >> 2] !== n)
							return (
								d(
					...
					m: function (e, n, t, r, a) {
						...
						var f = e + 112,
							...
							v = !!(64 & _);
						if ('EM_IDB_STORE' === l)
							(l = C[(f + 84) >> 2]), Ge(e, I.slice(l, l + C[(f + 88) >> 2]), c, s);
				...
				Mt =
					((i._emscripten_current_thread_process_queued_calls = function () {
						return (i._emscripten_current_thread_process_queued_calls = i.asm.X).apply(
							null,
							arguments
						);
					}),
					(i._emscripten_register_main_browser_thread_id = function () {
						return (Mt = i._emscripten_register_main_browser_thread_id = i.asm.Y).apply(
							null,
							arguments
						);
					})),
				...
				It = (i._emscripten_main_thread_process_queued_calls = function () {
					return (It = i._emscripten_main_thread_process_queued_calls = i.asm.$).apply(
						null,
						arguments
					);
				}),
				Dt = (i._emscripten_run_in_main_runtime_thread_js = function () {
					return (Dt = i._emscripten_run_in_main_runtime_thread_js = i.asm.aa).apply(
						null,
						arguments
					);
				}),
	...
	('undefined' != typeof global &&
		...
		? (function () {
				...
				onmessage = self.onmessage = (e) => {
					'custom' === e.data.cmd
						? 'function' == typeof a.onCustomMessage && a.onCustomMessage(e.data.userData)
						: r(e);
				};
			})()
		: ('undefined' != typeof onmessage &&
			...
			? ((r =
				...
				r
					? require.main === module
						? ((t = require('path').join(__dirname, 'stockfish-16.wasm')),
							(e = {
					...
					: ((r = self.location.hash.substr(1).split(',')),
						(t = decodeURIComponent(r[0] || 'stockfish-16.wasm')),
						(e = {
							locateFile: function (e) {
